...
public class DBHelper extends SQLiteOpenHelper{
    ...
    // Start of Modification for the Database Schema to add two more columns in the database.
                Contract.TABLE_TODO.COLUMN_NAME_COMPLETE + " BOOLEAN, "+
                Contract.TABLE_TODO.COLUMN_NAME_CATEGORY+ " TEXT NOT NULL " + "); ";
    // End of Modification for the Database Schema.
